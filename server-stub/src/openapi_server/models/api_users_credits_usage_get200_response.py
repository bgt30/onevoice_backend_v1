...
class ApiUsersCreditsUsageGet200Response(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["total_credits", "used_credits", "remaining_credits", "current_period_start", "current_period_end"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ApiUsersCreditsUsageGet200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ApiUsersCreditsUsageGet200Response from a dict"""
        if obj is None:
            return None
