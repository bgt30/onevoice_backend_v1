...
class ApiVideosGet200Response(BaseModel):
    """
    ApiVideosGet200Response
    """ # noqa: E501
    videos: Optional[List[Video]] = None
    pagination: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["videos", "pagination"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ApiVideosGet200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ApiVideosGet200Response from a dict"""
        if obj is None:
            return None
