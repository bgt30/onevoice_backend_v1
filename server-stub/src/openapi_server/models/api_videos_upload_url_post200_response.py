...
class ApiVideosUploadUrlPost200Response(BaseModel):
    """
    ApiVideosUploadUrlPost200Response
    """ # noqa: E501
    upload_url: Optional[StrictStr] = None
    video_id: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["upload_url", "video_id"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ApiVideosUploadUrlPost200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ApiVideosUploadUrlPost200Response from a dict"""
        if obj is None:
            return None
